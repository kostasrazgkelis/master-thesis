...
class TestDatasetEvaluator(unittest.TestCase):
    ...
    def test_evalut_with_1000_size(self):
        ...
        self.assertEqual(
            evaluator.tp, expected["tp"], "True positives do not match expected value"
        )
        self.assertEqual(
            evaluator.fp, expected["fp"], "False positives do not match expected value"
        )
        self.assertEqual(
            evaluator.fn, expected["fn"], "False negatives do not match expected value"
        )
